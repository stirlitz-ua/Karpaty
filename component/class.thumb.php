<?
/*
$filename = "../photo/news/facts_$pcat.jpg";
$tn_image = new Thumbnail( $_FILES["facts"]["tmp_name"], 350, 0, 0, 80 ); $tn_image->save( $filename );
*/
...
class Thumbnail {
    ...
    function Thumbnail($file, $max_width = 0, $max_height = 0, $percent = 0, $jpeg_quality = 80) {
  if (!file_exists($file)) {
  ...
  #
  # Good idea from Mariano Cano Pйrez
