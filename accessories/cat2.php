...
<body>
<div align="center" style="height:250px; padding-bottom:30px;">
<a href="/"><img src="pic/banner.jpg" style="width:888px; height:280px;"></a>
</div>
...
<tr><td>
<input onblur="inputBG(this,0)"  onfocus="inputBG(this,1)" name="poisk" type="text" placeholder="Введите название аксессуара..." style="width:209px;" />
...
<?
if($_GET['act']==''){
echo'<h1 style="margin-left:-50px;">Общий каталог:</h1>';
...
if (mysql_num_rows($basecat) > 0)
{
	...
	$basecat1 = mysql_query("SELECT `cat_id`,`cat_name` FROM `cat_cat` WHERE `cat_papa`='114' ORDER BY `cat_name`",$db) or die(mysql_error());
...
$basecat = mysql_query("SELECT `cat_id`,`cat_name`,`cat_pic`,`glass` FROM `cat_cat` WHERE `cat_papa`='0' AND `glass` is NULL ORDER BY `cat_name`",$db) or die(mysql_error());
if (mysql_num_rows($basecat) > 0)
{
	$rowcat = mysql_fetch_array($basecat);
	do { 
