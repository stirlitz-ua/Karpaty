...
$('#sawe_cena2').click(function(){
    ...
    $.getJSON('/ajax.php', {id:id, v:v, action:'cenna2' }, function(obj){
...
$('.cl_rem').click(function(){

    id=$(this).attr('rel');
	//console.log(id);

    $.getJSON('/ajax.php', {id:id,action:'clrem'}, function(obj){
        if(obj.json==0){
...
$('.remove_comp').click(function(){

    id=$(this).attr('rel');
	console.log(id);

    $.getJSON('/ajax.php', {id:id,action:'varrem'}, function(obj){
        if(obj.json==0){
