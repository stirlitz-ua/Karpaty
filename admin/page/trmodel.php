...
?>
    ...
    <th><span class="menu_moidelth <?if($rez['press']==0){echo ' red';}?>" onclick="menuclik('press', <?echo $_GET['view'];?>);">Пресса</span></th>
     ...
     <th><span class="menu_moidelth <?if($rez['sale_cars']==0){echo ' red';}?>" onclick="menuclik('review', <?echo $_GET['view'];?>);">Акционные автомобили</span></th>
...
while($model=mysql_fetch_array($md)){
    ...
    <a href="?models='.$model['id'].'"><i class="icon-share"></i></a>';
