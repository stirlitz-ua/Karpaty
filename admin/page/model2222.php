...
<div class="control-group <?echo $weight;?>">
    ...
    <label class="control-label" for="small-1">Weight</label>

    <div class="controls">

    <input class="span2" id="small-1" name="weight" value="<?if(isset($_POST['weight'])){echo $_POST['weight'];}?>" type="number">
...
<div class="control-group <?echo $weight;?>">
    ...
    <input class="span2" id="small-1" name="weight" value="<?if(isset($_POST['weight']) and $_POST['weight']!=''){echo $_POST['weight'];}else{echo $model['weight'];}?>" type="number">
