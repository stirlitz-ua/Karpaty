 ...
 if($_GET['page']!=''){
    switch($_GET['page']){
      case('salesavto'): $hed="Акционные автомобили в наличии";$id_menu='5'; break;
        ...
        case('catalog'): $hed="Каталог";$id_menu='5'; break;
...
if($ename=='' and  $epname=='' and $elink=='' and $error_title=='' and $error_des=='' and $error_key=='' and $error_photo==''){
    ...
    echo "<html> <head> <meta HTTP-EQUIV='Refresh' CONTENT='5; URL=./?page=".$_GET['page']."'></head><body>";
    }}
?>
...
if($ename=='' and  $elink=='' and $error_title=='' and $error_des=='' and $error_key=='' and $error_photo==''){
 ...
 // echo $_POST['text'].'<br><hr><br>'.$text.'<br><hr><br>';
    ...
    echo "<html> <head> <meta HTTP-EQUIV='Refresh' CONTENT='5; URL=./?page=".$_GET['page']."&arr=".$_GET['add_pp']."'></head><body>";
...
echo "<html> <head> <meta HTTP-EQUIV='Refresh' CONTENT='5; URL=./?page=".$_GET['page']."&arr=".$prd['id_arr']."'></head><body>";
}}
...
*/
    ...
    $prods=mysql_fetch_array(mysql_query("SELECT * FROM  `arr` WHERE id='".$_GET['arr']."'"));
            ...
            if(isset($_GET['arov_down'])){
                ...
                echo "<html> <head> <meta HTTP-EQUIV='Refresh' CONTENT='5; URL=./?page=".$_GET['page']."&arr=".$_GET['arr']."'></head><body>";
            }
