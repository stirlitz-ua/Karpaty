...
//titles
if(isset($_GET['catalog']) and $_GET['catalog']!=''){

    switch($_GET['catalog']) {
        case("catalog"): if(empty($_GET['pmenu'])) $rez=mysql_fetch_array(mysql_query("SELECT t,d,k FROM accessories WHERE link='$_GET[menu]'")); else
